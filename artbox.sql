...
--
-- Host: 127.0.0.1
-- Creato il: Set 23, 2025 alle 17:38
...
--
-- Struttura della tabella `oeuvres`
--
...
--
-- Dump dei dati per la tabella `oeuvres`
--
...
(8, 'Blast from the past', 'Nunc fermentum purus dapibus juste fermentum auctor. Maecenas non tincidunt leo. Morbi vitae iaculis sem. Donec quis scelerisque massa. Fusce quis accumsan diam, et interdum lectus. Suspendisse mattis pulvinar vehicula. Duis nisi.', 'Juliette Baskerville', 'img/steve-johnson-6.png'),
...
--
-- AUTO_INCREMENT per la tabella `oeuvres`
--
ALTER TABLE `oeuvres`
